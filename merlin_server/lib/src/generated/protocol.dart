...
import 'google_oauth/google_oauth_token.dart' as _i7;
import 'greetings/greeting.dart' as _i8;
import 'user_profile/user_profile.dart' as _i9;
import 'package:merlin_server/src/generated/calendar/calendar.dart' as _i10;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i7.GoogleOAuthToken) {
      return _i7.GoogleOAuthToken.fromJson(data) as T;
    }
    if (t == _i8.Greeting) {
    ...
    if (t == _i1.getType<_i7.GoogleOAuthToken?>()) {
      return (data != null ? _i7.GoogleOAuthToken.fromJson(data) : null) as T;
    }
    ...
    if (t == List<_i10.Calendar>) {
      return (data as List).map((e) => deserialize<_i10.Calendar>(e)).toList()
          as T;
    }
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      ...
      _i7.GoogleOAuthToken => 'GoogleOAuthToken',
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'GoogleOAuthToken') {
      return deserialize<_i7.GoogleOAuthToken>(data['data']);
    }
